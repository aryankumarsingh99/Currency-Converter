...
export default function Converter() {
  ...
  return (
    <motion.div
      className="bg-gradient-to-br from-indigo-200 via-blue-100 to-purple-100 rounded-3xl shadow-2xl p-10 max-w-xl w-full flex flex-col items-center border border-indigo-100"
    ...
    >
      ...
      <h2 className="text-3xl font-extrabold text-center mb-6 text-indigo-700 drop-shadow-lg tracking-tight">
        Currency Converter
      </h2>
      <form
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="border-2 border-indigo-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white/80 text-lg font-semibold transition"
          />
        </div>
